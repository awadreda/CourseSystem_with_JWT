...
import { School, Email, Grade, MenuBook, AccountCircle } from "@mui/icons-material"
        ...
        <Box display="flex" alignItems="center" gap={3}>
          ...
          <Box flex={1}>
            ...
            <Stack direction="row" spacing={2} alignItems="center" mb={2}>
              <Chip icon={<School />} label={user.role} sx={{ bgcolor: "rgba(255,255,255,0.2)", color: "white" }} />
          ...
          <Card elevation={2} sx={{ height: "100%", borderRadius: 3 }}>
            <CardContent sx={{ p: 3 }}>
              ...
              <Box textAlign="center" mb={3}>
                <Typography variant="h2" fontWeight="bold" sx={{ color: getGPAColor(gpa) }}>
                  {gpa.toFixed(1)}
                </Typography>
